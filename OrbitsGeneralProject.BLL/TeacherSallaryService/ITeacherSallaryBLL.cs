...
namespace Orbits.GeneralProject.BLL.TeacherSallaryService
{
    public interface ITeacherSallaryBLL
    {
        ...
        Task<IResponse<TeacherMonthlySummaryDto>> GetMonthlySummaryAsync(int requesterUserId, int? teacherId = null, DateTime? month = null);
        ...
        Task<IResponse<TeacherSallaryDetailsDto>> GetInvoiceDetailsAsync(int requesterUserId, int invoiceId);

        /// <summary>
        /// Retrieves a salary invoice by its identifier.
        /// </summary>
        /// <param name="invoiceId">The invoice identifier.</param>
        Task<IResponse<TeacherInvoiceDto>> GetInvoiceByIdAsync(int requesterUserId, int invoiceId);
        ...
        /// </summary>
        /// <param name="invoiceId">The invoice identifier.</param>
        Task<IResponse<string?>> GetPaymentReceiptPathAsync(int requesterUserId, int invoiceId);
    }
}
